 ...
 *
 */
public class UdpConfigInit implements Serializable{
	 ...
	 */
	public UdpConfigInit(String host, int port, int timeLimit, int reconnectTime, int disConnectTime) {
		this.host = host;
		this.port = port;
	}

	public UdpConfigInit(String host, int port) {
		this.host = host;
		this.port = port;
		this.timeLimit = 10;
